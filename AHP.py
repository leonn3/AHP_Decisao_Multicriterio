...
class AHP():
    ...
    def __init__(self,metodo, precisao, alternativas, criterios, subCriterios, matrizesPreferencia, log=False):
        self.metodo = metodo
        self.precisao = precisao
        self.alternativas = alternativas
        self.criterios = criterios
        self.subCriterios = subCriterios
        self.matrizesPreferencia = matrizesPreferencia
        self.log = log
    ...
    def VetorPrioridadesLocais(self):
        ...
        for criterio in self.matrizesPreferencia:
            matriz = np.array(self.matrizesPreferencia[criterio])
            ...
            if self.log:
                ...
                print('Labda_max = ', lambda_max)
                print('Indice de consistencia de ' + criterio + ' = ', round(ic, self.precisao))
                print('Razao de consistencia de '+ criterio + ' = ', round(rc, 2))
...
""" if __name__ == '__main__':
    ...
    precisao = 2
    print('Aproximado: ', AHP.Aproximado(matriz, precisao))
    print('Geometrico: ', AHP.Geometrico(matriz, precisao))
    print('Autovalor: ', AHP.Autovalor(matriz, precisao))
    print('Consistencia: ', AHP.Consistencia(matriz)) """